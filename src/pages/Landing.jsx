...
import { scrollToSection, instagram } from "../scripts/Links.js";
...
export default function Landing() {
  return (
    <>
      ...
      >
        ...
        <div className="font-helvetica lowercase text-surface-0">
          <span
            ...
            className="px-1.5 bg-main-0 border absolute top-[50%] left-[30%] cursor-pointer select-none"
          >
            about
          </span>
          <span
            ...
            className="px-1.5 bg-main-0 border absolute top-[30%] left-[25%] cursor-pointer select-none"
          >
            my work
          </span>
          <span
            ...
            className="px-1.5 bg-main-0 border absolute top-[38%] right-[10%] cursor-pointer select-none"
          >
            let's collab
          </span>
        </div>
      ...
      <div
        id="about-section"
        className="w-full min-h-dvh text-main-0 bg-surface-0 border-t-4 border-dashed border-main-0"
      >
        <img
          id="id-design"
          src={ID}
        ...
        <div
          ...
          className="px-20 font-bespoke text-center text-sm"
        >
      ...
      <div
        ...
        className="min-h-fit text-main-0 bg-cherry-0 flex justify-center items-center flex-col py-20 border-t-4 border-dashed border-main-0"
      >
      ...
      <div
        id="email-section"
        className="min-h-fit w-full px-3 bg-cherry-0 border-t-4 border-dashed border-main-0 text-main-0 -mb-1"
      >
      ...
      <div id="contact-section" className="min-h-fit w-full bg-cherry-0 pb-1">
        ...
        >
          <div className="font-helvetica text-xl text-main-0 rounded-lg">
            Socials
          </div>
